...
const Sidebar = () => {
  ...
  return(!isSidebarOpen? (
    <div className='w-28 h-screen mr-4'>
       <ul className=' p-2'>
       <Link to={'/'}>
       <li className='w-24 p-2 m-4 hover:bg-[#f2f2f2] rounded-md flex flex-col items-center'>
            <div className="text-2xl mb-2">🏠</div>
            <div className="text-sm">Home</div>
      </li> 
       </Link>
        <li className='w-24 p-2 m-4 flex flex-col items-center hover:bg-[#f2f2f2] rounded-md'>
          <div className='text-2xl mb-2'>📷</div>
